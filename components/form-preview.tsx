                    ...
                    switch (component.type) {
                            ...
                            return (
                                <div key={component.id} className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleInputChange(component.key, e.target.value)
                                        }
                            ...
                            return (
                                <div key={component.id} className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="border border-purple-200 focus:border-purple-400 focus:ring-purple-400 rounded-md px-3 py-2"
                                    />
                                </div>
                            );
                                    ...
                                    <div className="space-y-2 bg-white p-3 rounded-md border border-purple-100">
                                        {component.options?.map((option: any) => (
                                            ...
                                            >
                                                ...
                                                />
                                                <Label htmlFor={`${component.key}-${option.value}`}>
                                                    {option[language]}
                                                </Label>
                                            </div>
                                        ))}
                                    ...
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            ...
                                            >
                                                ...
                                                {formValues[component.key]
                                                    ? format(
                                                          new Date(formValues[component.key]),
                                                          'PPP',
                                                      )
                                                    : `Select ${label}`}
                                            </Button>
                                        ...
                                        <PopoverContent className="w-auto p-0" align="start">
                                            <Calendar
                                                ...
                                                onSelect={(date) =>
                                                    handleInputChange(component.key, date)
                                                }
                                                initialFocus
                                            />
                                        </PopoverContent>
                        ...
                        case 'heading':
                            return (
                                <h2
                                    key={component.id}
                                    className="text-xl font-bold text-purple-800 border-b border-purple-200 pb-2"
                                >
                                    {label}
                                </h2>
                            );
