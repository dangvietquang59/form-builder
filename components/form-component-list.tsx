                    ...
                    <div className="space-y-4">
                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab}>
                            ...
                            <TabsContent value="en" className="space-y-4 pt-4">
                                <div className="space-y-2">
                                    <Label htmlFor={`label-en-${component.id}`}>
                                        Label (English)
                                    </Label>
                                    <Input
                                ...
                                {(component.type === 'text' ||
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor={`placeholder-en-${component.id}`}>
                                            Placeholder (English)
                                        </Label>
                                        <Input
                                            ...
                                            onChange={(e) =>
                                                handlePlaceholderChange('en', e.target.value)
                                            }
                                            className="border-purple-200 focus:border-purple-400"
                                        />
                                    </div>
                            ...
                            <TabsContent value="zh" className="space-y-4 pt-4">
                                <div className="space-y-2">
                                    <Label htmlFor={`label-zh-${component.id}`}>
                                        Label (Chinese)
                                    </Label>
                                    <Input
                                ...
                                {(component.type === 'text' ||
                                    ...
                                    component.type === 'phone') && (
                                    <div className="space-y-2">
                                        <Label htmlFor={`placeholder-zh-${component.id}`}>
                                            Placeholder (Chinese)
                                        </Label>
                                        <Input
                                            ...
                                            onChange={(e) =>
                                                handlePlaceholderChange('zh', e.target.value)
                                            }
                                            className="border-purple-200 focus:border-purple-400"
                                        />
                                    </div>
                            ...
                            <TabsContent value="vi" className="space-y-4 pt-4">
                                <div className="space-y-2">
                                    <Label htmlFor={`label-vi-${component.id}`}>
                                        Label (Vietnamese)
                                    </Label>
                                    <Input
                                ...
                                {(component.type === 'text' ||
                                    ...
                                    component.type === 'phone') && (
                                    <div className="space-y-2">
                                        <Label htmlFor={`placeholder-vi-${component.id}`}>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) =>
                                                handlePlaceholderChange('vi', e.target.value)
                                            }
                                            className="border-purple-200 focus:border-purple-400"
                                        />
                                    </div>
