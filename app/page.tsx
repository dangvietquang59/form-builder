            ...
            <div className="flex flex-col items-center justify-center space-y-8">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-muted-foreground">
                        Create, deploy, and manage dynamic forms with multilingual support
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Create and configure new forms with multilingual support
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <p>
                                Design forms with various components including text fields,
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p>
                                Access your deployed forms, view submissions, and make updates to
                                existing forms.
                            </p>
                        </CardContent>
                        <CardFooter>
